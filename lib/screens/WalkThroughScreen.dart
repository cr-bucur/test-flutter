  ...
  init() async {
    ...
    list.add(
      WalkThroughModel(
        ...
        subTitle: 'Legal Easy offers an awesome category filter option which will let you access what you are interested in straight away!',
        color: colorPrimary,
      ),
    );
    list.add(
      WalkThroughModel(
        ...
        subTitle: 'Legal Easy is a complete set of incredible, easily importable UI and get regular updates by subscribing to it!',
